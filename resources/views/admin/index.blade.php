    ...
    <div class="dash_login_left">
        <article class="dash_login_left_box">
            <header class="dash_login_box_headline">
                ...
                <h1><img src="{{ url(asset('backend/assets/images/favicon.png')) }}" alt=""> Login</h1>
            </header>
            ...
            <footer>
                <p>Desenvolvido por <b>Everaldo</b> Lima</a></p>
                <p>&copy; <?= date("Y"); ?> - Todos os Direitos Reservados</p>
                <p class="dash_login_left_box_support">
                    <a target="_blank"
                       class="icon-whatsapp transition text-green"
                       href="https://api.whatsapp.com/send?phone=5513988491908&text=Olá, preciso de ajuda com o login."
